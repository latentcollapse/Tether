...
## BOOTSTRAP SCOPE (AUTHORITATIVE):

This capsule bootstraps HLX literacy, not execution.

After loading this capsule, a model can:
- Read and write HLX (Runic) and HLXL (ASCII)
- Validate HLX structure and syntax
- Lower HLX programs to HLX-Lite values
- Encode and decode LC-T and LC-B
- Construct and verify LC_12 transfer envelopes

Execution of HLX programs requires an external HLX runtime.
The capsule intentionally does not define runtime behavior.
